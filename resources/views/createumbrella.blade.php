    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-danger">
                <div class="panel-heading">新增共傘需求
                </div>
                <div class="panel-body">
                  <form class="form-horizontal" role="form" method="POST" action="{{url('storeumbrella')}}">
                        {{ csrf_field() }}
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control mustFill" id="leavMsgTitl" type="text" name="end_name" style="width:20%" placeholder="EX:管院">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control mustFill" id="leavMsgTitl" type="text" name="end_lng" style="width:20%" placeholder="EX:121.193809">
                      <label class="col-md-6 control-label" for="leavMsgCont">
                        輸入目的地緯度：
                      </label>
                      <input class="form-control mustFill" id="leavMsgTitl" type="text" name="end_lat" style="width:20%" placeholder="EX:24.971047">
                    </div>
                    <br>
